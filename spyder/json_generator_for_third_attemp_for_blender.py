...
for FEATURE_NUMBER in range(0,17):
    ...
    for polygon in polygons:
        ...
        for kk in range(0,number_of_points):
            points.append([polygon.GetX(kk),polygon.GetY(kk),polygon.GetZ(kk)])
        ...
        output_path=r"C:\Users\ignac\Upwork\Tom Hayden\Fourth_Map\layer_info_json_for_step_blender"
        ...
        file.write('\n')
        file.write('"coordinates":'+ str(new_coordinates[:-1]).replace("(","[").replace(")","]")+',' )
        file.write('\n')
